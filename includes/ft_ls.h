...
/*   Updated: 2019/07/18 11:58:16 by jhamon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					sort_tree(t_tree *tmp,
							t_file *new_data, char flags, t_freemoi *eldoctor);
void					recursive_while(char flags,
							t_tree *tree, t_freemoi *eldoctor);
void					simple_print(char *files,
							char flags, t_freemoi *eldoctor);
void					multi_print(char **files,
							char flags, t_freemoi *eldoctor);
void					fild_tree(DIR *dir_files,
							char *path, t_apaletemps *plt, t_freemoi *eldoctor);
...
char					**cpy_parms(const char **argv,
							int argc, int i, t_freemoi *eldoctor);
t_file					*create_data_file(char *dir_file, t_freemoi *eldoctor);
void					add_patient(t_freemoi **eldoctor,
